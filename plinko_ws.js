...
const PLINKO_TABLE = {
  ...
  med: { /* ... (unchanged — omitted here for brevity) ... */ },
  hard: { /* ... (unchanged — omitted here for brevity) ... */ },
  harder: { /* ... (unchanged — omitted here for brevity) ... */ },
  insane: { /* ... (unchanged — omitted here for brevity) ... */ },
  extreme: { /* ... (unchanged — omitted here for brevity) ... */ },
};
